...
function create(inputs){
 const d=freeze(clone(root.HEWRS_BLAZER_CONNECTION_DATA));
 ...
 const base=original.create(inputs,{configurationFilter:req=>!/^B\d+$/.test(req.topwearId)||Object.hasOwn(d.assembly.ties,req.tieId)});
 ...
 function queryIssue(q){
  ...
  if(q.tie?.mode==='none'||q.tie?.id==='REFERENCE')return 'No existing no-tie assembly for this blazer request';
