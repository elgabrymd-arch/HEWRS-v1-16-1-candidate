...
W,H=996,2748
IDS=['DS002','DS004','DS005','DS006','DS007','DS008','DS015','DS018','DS019','DS021','DS022','DS023','DS024','DS025','DS027','DS047']
...
for file,text in [('data/batch10.json',json_text),('data/batch10.js',js_text)]:
 if args.check:
  assert (R/file).read_text()==text, 'Changed derivative registry: '+file
 else:
