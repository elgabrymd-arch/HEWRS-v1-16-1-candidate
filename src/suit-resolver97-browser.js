/* Mechanical browser wrapper of preserved vendor/cp98/suit_resolver97.mjs. */
(function(root){
...
function resolveSuit(registry, suitId) {
...
async function checkedFetch(asset, baseURL, fetchImpl=fetch) {
...
function createAtomicSuitSelector(registry, loadCheckedAsset, commitPair) {
  let revision=0;
...
root.HEWRSSuitResolver97=Object.freeze({resolveSuit,checkedFetch,createAtomicSuitSelector});
})(globalThis);
